...
<section class="section-padding error-page pattern-bgs gray ">
    <div class="container">
        <div class="row">
            <?php if ($adforest_theme['blog_sidebar'] == 'left') get_sidebar(); ?>
                    ...
                    <div class="single-blog blog-detial">
                        <div class="blog-post">
                            <?php
                                ...
                                ?>
                                <div class="post-img">
                                    <a href="javascript:void(0);"><img class="img-responsive" src="<?php echo esc_url($response[0]); ?>" alt="<?php the_title(); ?>"></a>
                                </div>
                                <?php } ?>
