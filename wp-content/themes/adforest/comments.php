...
<ol class="comment-list"><?php wp_list_comments(array('callback' => 'adforest_comments_list', 'style' => 'ul'));?></ol>
</div>
<?php } ?>
<?php
...
<div class="blog-section">
    <div class="blog-heading">
        <div class="blog-comment-title"><?php echo __('leave your comment', 'adforest');?></div>
        <hr>
    </div>
    <?php
    $req = '*';
