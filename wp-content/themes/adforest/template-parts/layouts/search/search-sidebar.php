...
$section_class = '';
if (wp_is_mobile()) {$section_class = 'section-no-pad ';} ?>
<div class="main-content-area clearfix">
<section class="section-padding <?php echo esc_attr($section_class);?><?php echo esc_attr($adforest_theme['search_bg']);?>">
<div class="container">
    <div class="row">
        <?php get_sidebar('ads');?>
        <div class="<?php echo esc_attr($left_col);?> <?php echo esc_attr($adforest_theme['search_res_bg']);?>">
            <div class="row">
                    ...
                    <div class="listingTopFilterBar">
                        <div class="col-md-7 col-xs-12 col-sm-7 no-padding">
                            <ul class="filterAdType">
                                <li class="active"><span class="filterAdType-count" ><?php echo __('Found Ads', 'adforest');?><small>(<?php echo esc_html($results->found_posts);?>)</small></span></li>
                                <?php
                                $param = $_SERVER['QUERY_STRING'];  if ($param != "") { ?>
                                    <li class=""><a class="filterAdType-count" href="<?php echo get_the_permalink($sb_search_page);?>"><?php echo __('Reset Search', 'adforest');?></a></li>
                                    <?php  }
                                ...
                                if (isset($adforest_theme['search_layout_types']) && $adforest_theme['search_layout_types'] == true) { ?>
                                    <li class="<?php echo (is_rtl() ) ? 'pull-left' : 'pull-right';?>"><a class="filterAdType-count" href="<?php echo esc_url($list_view);?>" class="<?php echo (is_rtl() ) ? 'pull-left' : 'pull-right';?>"><i class="fa fa-bars"></i></a><a class="filterAdType-count" href="<?php echo esc_url($grid_view);?>" class="pull-right"><i class="fa fa-th-large"></i></a></li>                      
                                <?php } ?>
                            </ul>
                        </div>
                ...
                <?php } ?>
                <div class="clearfix"></div>
                <?php if (isset($adforest_theme['sb_allow_cats_above_filters']) && $adforest_theme['sb_allow_cats_above_filters']) {
                        ...
                        if (count($ad_cats) > 0) {
                            ...
                            foreach ($ad_cats as $ad_cat) {
                                ...
                                if ($rows_count > $max_rows && $show) {
                                    $show = false;
                                    $res .= '<li class="col-md-12 col-sm-12 col-xs-12 hide_cats text-center margin-top-20"><a href="javascript:void(0);" >'. __('Show more', 'adforest').'</a></li>';
                                ...
                                <div class="adforest-new-filters">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="headingOnez">
                                            <h4 class="panel-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOnez" aria-expanded="true" aria-controls="collapseOnez">
