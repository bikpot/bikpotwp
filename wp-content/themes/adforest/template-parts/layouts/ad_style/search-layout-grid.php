...
<?php $out = '<div class="posts-masonry">'; ?>
<?php
// The Loop
$layout = 'grid_1';
...
if (isset($type)) { $layout = $type; }
$c = 6;
if (isset($col)) { $c = $col; }

if (isset($adforest_theme['design_type']) && $adforest_theme['design_type'] == 'modern' && basename(get_page_template()) != 'page-search.php') {
    //$c = 4;
}
$marker_counter = 1;
...
while ($results->have_posts()) {
    ...
    $pid = get_the_ID();
    $ads = new ads();
    $layout = isset($layout) && !empty($layout) ? $layout : 'grid_1';
    $option = $layout;
