	...
	'fields' => apply_filters( 'comment_form_default_fields', array(
			...
			'author' => '<div class="col-sm-4"><div class="form-group"><label for="author">'
				.esc_html__( 'Name', 'adforest' ).( $req ? '<span class="required">*</span>' : '' ).'</label>' . 
					'<input type="text" required placeholder="'.esc_html__( 'Your Good Name', 'adforest' ).'" id="author" class="form-control" name="author" size="30"/></div></div>', 
			...
			'email' => '<div class="col-sm-4"><div class="form-group"><label for="email">'
				.esc_html__( 'Email', 'adforest' ).( $req ? '<span class="required">*</span>' : '' ).'</label>' . 
					'<input type="email" required placeholder="'.esc_html__( 'Your Email Please', 'adforest' ).'" id="email" class="form-control" name="email" size="30" /></div></div>', 

			/* URL Field Setting Goes Here */
			'url' => '<div class="col-sm-4"><div class="form-group"><label for="url">'
				.esc_html__( 'Website', 'adforest' ) . '</label>' . 
					'<input type="text" required placeholder="'.esc_html__( 'Your URL Please', 'adforest' ).'" id="url" class="form-control" name="url" size="30"' . "" . ' /></div></div>', 
			...
			'comment_field' => '<div class="col-sm-12"><div class="form-group"><label for="url">'
				...
				'<div class="col-sm-12"><div class="form-group"><textarea class="form-control" id="comment" name="comment" required cols="45" rows="7" aria-required="true" ></textarea></div></div>', 	
		'comment_notes_after' => '',
	);
