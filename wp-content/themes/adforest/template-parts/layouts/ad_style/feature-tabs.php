...
<ul>
  <li><a class="page-scroll" href="#description"><i class="fa fa-file-text"></i> <?php echo __('Description','adforest'); ?></a></li><?php if( get_post_meta($pid, '_adforest_ad_yvideo', true ) != "" ) { ?>
  ...
  <li><a class="page-scroll" href="#ad-rating"><i class="fa fa-star"></i> <?php echo __('Rating','adforest'); ?></a></li>
  <?php } ?>
</ul>
</div>