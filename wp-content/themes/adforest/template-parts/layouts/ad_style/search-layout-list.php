...
$out = '';
if ($layout == 'list_1') {
    $out .= '<div class="col-md-12 col-xs-12 col-sm-12"><div id="products" class=" mid-container list-group"><div class="row">';
} else if ($layout == 'list_2') {
    $out .= '<div class="posts-masonry"><div class="col-md-12 col-xs-12 col-sm-12">';
} else if ($layout == 'list_3') {
    $out .= '<div class="col-md-12 col-sm-12 col-xs-12"><ul>';
}
// The Loop
$marker_counter = 1;
