                            ...
                            if (get_current_user_id() == "") {
                                ...
                                <div class="ad-sidebar-form">
                                    <form id="send_message_pop" method="post">
                                      ...
                                      echo       
                                        '<button type="button"  class="btn btn-theme chat_toggler"  data-page_id ='.get_the_ID().'    data-user_id ='.esc_attr($poster_id).'><i class="fa fa-commenting-o"></i> '. __("Whizzchat", "adforest").'</button>';
                                         } 

                                        if($allow_whatsapp){
                                     echo   '<a  href="https://api.whatsapp.com/send?phone='.esc_attr($contact_num).'"  class="btn btn-theme whatsapp-message"><i class="fa fa-whatsapp"></i> '.__("whatsapp", "adforest").'</a>';
                                   }
                                    ?>
                                    </form>
                                </div>
