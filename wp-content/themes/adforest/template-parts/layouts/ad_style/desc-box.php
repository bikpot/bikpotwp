...
<div class="descs-box" id="description">
    ...
    if (get_post_meta($pid, '_adforest_ad_yvideo', true) != "") {
        ...
        if (isset($match[1]) && $match[1] != "") {
            ...
            $video_id = $match[1];
            ?><div id="video"><div class="heading-panel"><div class="main-title text-left"><?php echo __('Ad Video', 'adforest');?></div></div><?php
                $iframe = 'iframe';
    ...
    if (isset($adforest_theme['allow_lat_lon']) && $adforest_theme['allow_lat_lon']) {
        ...
        <div id="map-location">
            <div class="heading-panel">
                <div class="main-title text-left"><?php echo __('Location', 'adforest');?></div>
            </div>
            <?php
