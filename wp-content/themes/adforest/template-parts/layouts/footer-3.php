...
<footer class="minimal-footer-1 sb-foot-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <aside class="widget">
                    <div class="widget-title"><?php echo esc_html($adforest_theme['section_2_title']); ?></div>
                ...
                <aside class="widget text-center">
                    ...
                    <div class="social-links">
                        ...
                        foreach ($adforest_theme['social_media'] as $index => $val) {
                            ...
                            <?php
                            if ($val != "") {
                                ?><a <?php do_action('adforest_relation_follow_links');?>href="<?php echo esc_url($val); ?>"><i class="<?php echo adforest_social_icons($index); ?>"></i></a><?php
                            }
                        }
                        ?>
                    </div>
            ...
            <div class="col-sm-4">
                <aside class="widget">
                    <div class="widget-title"><?php echo esc_html($adforest_theme['section_3_title']); ?></div>
