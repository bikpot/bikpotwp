                ...
                <div class="col-md-12 col-lg-12 col-xs-12">
                    <div class="comment-section ad-box">
                        ...
                        if (count($ratings) > 0) {
                                ...
                                foreach ($ratings as $rating) {
                                    ...
                                    <li class="comment">
                                        <div class="comment-info">
                                            <a href="<?php echo adforest_set_url_param(get_author_posts_url($rator),'type','ads'); ?>"><img class="pull-left hidden-xs img-circle" src="<?php echo adforest_get_user_dp($rator, 'adforest-user-profile'); ?>" alt="<?php echo esc_attr($user->display_name); ?>"></a>
                                            <div class="author-desc">
                                                <div class="author-title">
                                                    <a href="<?php echo adforest_set_url_param(get_author_posts_url($rator),'type','ads') ; ?>"><strong><?php echo esc_html($user->display_name); ?></strong></a>
                                                    <br /><br />
                                                    <div class="rating">
                                                        <?php
                                                        for ($i = 1; $i <= 5; $i++) {
                            ...
                            ?>
                            <h6><?php echo __('Be the first to rate this user.', 'adforest'); ?></h6>
                            <?php
                        }
                        ?>
                        <div class="heading-panel">
