                                ...
                                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        foreach ($languages as $l) {
                                            ?>
                                            <li><a href="<?php echo $l['url']; ?>"><?php echo $l['native_name']; ?></a>
                                            </li>
                                            <?php
                                        }
                                        ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12">
                        ...
                        <p class="top-tittle text-capitalize mb-0"><?php echo esc_html__('Call Us:', 'adforest'); ?></p>
                                                        <h3 class="bottom-tittle"><?php echo $ad_menu_contact_num; ?></h3>
                        </span></li>
                                            <?php } 
                                                        ...
                                                        if (isset($prod_cat->term_id)) {
                                                            ...
                                                            <li>
                                                                <a href="<?php echo esc_url(get_term_link($prod_cat->term_id)); ?>">
                                                                    <span class="icon"><?php echo $product_image; ?></span>
                                                                    <p><?php echo $prod_cat->name; ?></p>
                                                                    <span class="cat-num"><?php echo $count; ?></span>
                                                                </a></li>
                                                        <?php }
                                                    } ?>
                                                </ul>
