...
<div class="sb-top-bar_notification"><span>
    ...
    <?php echo __('For a better experience please change your browser to CHROME, FIREFOX, OPERA or Internet Explorer.', 'adforest');?></span>
</div>
        <?php
        ...
        } else if (isset($adforest_theme['sb_header']) && $adforest_theme['sb_header'] == 'vendor-1') {
            get_template_part('template-parts/layouts/header', '12');
        } else {
