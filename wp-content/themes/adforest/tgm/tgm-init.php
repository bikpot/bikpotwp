...
function sb_themes_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('htthttps://downloads.wordpress.org/plugin/elementor.3.1.4.zip'),
            'is_callable' => '',
        ),   
        ...
        array(
            ...
            'source' => 'https://downloads.wordpress.org/plugin/dc-woocommerce-multi-vendor.3.7.0.zip',
            'required' => false,
            'version' => '',
            'force_activation' => false,
            'force_deactivation' => false,
        ...
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/one-click-demo-import.3.0.1.zip'),
            'is_callable' => '',
        ),
        array(
        ...
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/add-to-any.1.7.43.zip'),
            'is_callable' => '',
        ),
        array(
            ...
            'force_activation' => false,
            'force_deactivation' => false,
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/wp-twilio-core.1.3.2.zip'),
            'is_callable' => '',
        ),
    );
