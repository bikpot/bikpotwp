...
$left_col = 'col-md-8 col-lg-8 col-xs-12';
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-center" id=""> <i class="icon-gears"></i> <?php echo __('Select Any Category', 'adforest'); ?> 
