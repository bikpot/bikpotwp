...
if (!class_exists('ads')) {
    ...
    class ads {
        ...
        function adforest_get_ads_grid($args = array(), $paged ="", $show_pagination = 0, $fav_ads="") {
            $my_ads = '';
        ...
        function adforest_get_ads_grid_inactive($args = array(), $paged = 1, $show_pagination = 0, $fav_ads ="") {
            $my_ads = '';
            global $adforest_theme;
    ...
    <input type="hidden" id="max_pages" value="' . $ads->max_num_pages . '" />';
        ...
        function adforest_get_ads_grid_rejected($args = array(), $paged =1, $show_pagination = 0, $fav_ads ="") {
            $my_ads = '';
            global $adforest_theme;
        ...
        function adforest_get_featured_ads_grid($args = array(), $paged = 1, $show_pagination = 0, $fav_ads ="") {
            $my_ads = '';
            global $adforest_theme;
