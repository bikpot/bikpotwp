<?php 
namespace Adforest\Inc\Theme_shortcodes\Classes;
        ...
        function adforest_get_packages_style_1($args, $cols = 4) {
            ...
            if ($packages->have_posts()) {
                while ($packages->have_posts()) {
                    ...
                    if (get_post_meta(get_the_ID(), 'package_free_ads', true) != "") {
                        $free_ads = get_post_meta(get_the_ID(), 'package_free_ads', true) == '-1' ? __('Unlimited', 'adforest') : get_post_meta(get_the_ID(), 'package_free_ads', true);
            ...
            return '<div class="main-content-area clearfix">
             <section class="padding-top-40 bg-white">
                <div>
                   <div class="row">
                      <div class="col-md-12 col-xs-12 col-sm-12"><div class="pricing">' . $html . '</div></div>
                   </div>
                </div>
             </section>';
        }
