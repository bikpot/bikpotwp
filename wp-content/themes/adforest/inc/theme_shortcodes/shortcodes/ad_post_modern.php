...
' . $adforest_theme['sb_ad_update_notice'] . '
		...
		<div class="row">
		  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			 <label class="control-label">' . __('Click the box below to add photos', 'adforest') . ' <span class="required">*</span> <small>' . __('upload only jpg, png and jpeg files with a max file size of', 'adforest') . " " . $display_size . '</small></label>
                ...
                <div id="step-0" class="">
                   <div class="row">
                              <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
								 ...
								 <input class="form-control" placeholder="' . __('Enter title', 'adforest') . '" type="text" name="ad_title" id="ad_title" data-parsley-required="true" data-parsley-error-message="' . __('This field is required.', 'adforest') . '" value="' . $title . '" autocomplete="off">
