        ...
        vc_map(array(
            ...
            "params" => array(
                array(
                    ...
                    'description' => adforest_VCImage('pricing-modern.png') . __('Ouput of the shortcode will be look like this.', 'adforest'),
                ),
                array(
                ...
                if (isset($prod_id)) {
                    ...
                    $html .= '<div class="col-sm-6 col-lg-' . esc_attr($p_cols) . ' col-md-' . esc_attr($p_cols) . '">
                         ' . adforest_sale_html($product) . '
                           <div class="pricing-fancy adforest-packages">
                              <div class="icon-bg"><i class="flaticon-money-2"></i></div>
                              <h3><strong>' . get_the_title($prod_id) . '</strong></h3>
                              <div class="price-box">
                              
                                 <div class="price-large">
				 ' . adforest_product_price($product, 'modern') . '
                                 ' . $inner_html . '
								 <br />
...
if (function_exists('adforest_add_code')) {
    adforest_add_code('price_modern_short_base', 'price_modern_short_base_func');
}