...
if (!function_exists('apps2_short_base_func')) {
    ...
    function apps2_short_base_func($atts, $content = '') {
        ...
        if ($android_img != "") {
            ...
            $apps_html .= '<div class="android-logo-f2"> <a href="' . esc_url($a_link) . '" target="_blank"> <img src="' . $android_img . '" class="img-responsive"  alt="' . esc_attr('image', 'adforest') . '"></a> </div>';
        }


        if ($ios_img != "") {
            $ios_img = adforest_returnImgSrc($ios_img);
            $apps_html .= '<div class="ios-logo-f1"> <a href="' . esc_url($i_link) . '" target="_blank"><img src="' . $ios_img . '" class="img-responsive"  alt="' . esc_attr('image', 'adforest') . '"></a> </div>';
        }
    ...
    <div class="row">
      <div class="col-lg-6 col-xs-12 col-md-6 col-sm-7">
        <div class="mobile-apps-text">
          <div class="download-app-h2"><h2>' . $section_title . '</h2></div>
          <div class="mobile-apps-h3"><h3>' . $tag_line . '</h3></div>
          <div class="mobile-text-h5"><p>' . $section_description . '</p></div>
          ' . $apps_html . '
        </div>
      </div>
