...
if (!function_exists('cats_classic2_short_base_func')) {
    ...
    function cats_classic2_short_base_func($atts, $content = '') {
            ...
            if (isset($rows) && !empty($rows) && is_array($rows) && count($rows) > 0) {
                foreach ($rows as $row) {
                    ...
                    if (isset($row['cat']) && isset($icon_class)) {
                        ...
                        $categories_html .= '<div class="col-lg-3 col-xs-12 col-md-3 col-sm-6"><div class="vehicle-categories"><div class="new-vehicle-categories"><div class="vehicle-icons"> <i class="' . $icon_class . '"></i></div><div class="vehicle-text"><h2> <a href="' . adforest_cat_link_page($row['cat'], $cat_link_page) . '">' . $category->name . '</a> </h2></div></div><div class="vehicle-details"> <ul> ' . $sub_cat_html . ' </ul> </div><div class="explore-categories-button"><a href="' . adforest_cat_link_page($row['cat'], $cat_link_page) . '" class="over-view">' . __('View All', 'adforest') . '<i class="fa fa-angle-right"></i></a></div></div></div>';
	  ...
	  <div class="container">
		<div class="row">
		  ' . $header . '
		  <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12"> ' . $categories_html . ' </div>
		</div>
	  </div>
	</section>';
    }
