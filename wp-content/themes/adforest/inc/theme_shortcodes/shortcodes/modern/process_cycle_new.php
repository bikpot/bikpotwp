...
function process_cycle2_short()
{
	vc_map(array(
		...
		array(
		   ...
		   'description' => adforest_VCImage('process_cycle2.png') .  __( 'Ouput of the shortcode will be look like this.', 'adforest' ),
		  ),	
		  array(
...
return '<section class="how-it-work-repeat '.$section_bg.'">
  <div class="container">
    <div class="row">
      '.$header.'
