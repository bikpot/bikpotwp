    ...
    function shop_layout_modern_short_base_func($atts, $content = '') {
        ...
        if ($product_loop->have_posts()) {
            while ($product_loop->have_posts()) {
                ...
                if (!$sale) {
                    $regular_price = ($price) ? '<p>' . esc_html(adforest_shopPriceDirection($price, $currency)) . '</p>' : '';
                }
			...
			<div class="product-description-about">
			  ...
			  <div class="product-description">
				...
				<div class="product-description-text">' . $sale_price . $regular_price . ' </div>
			  </div>
			</div>
		  </div>';
            }
            ...
            <div class="container">
			   ...
			   ' . $header . '
                  <div class="col-md-12 col-xs-12 col-sm-12">
                     <div class="row style-3">' . $html . ' </div>
