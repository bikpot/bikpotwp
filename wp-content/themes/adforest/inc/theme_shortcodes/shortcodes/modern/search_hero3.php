...
if (!function_exists('search_hero3_short_base_func')) {
    ...
    function search_hero3_short_base_func($atts, $content = '') {
        ...
        if (isset($section_title) && $section_title != '') {
            ...
            $section_title_html = '<div class="classified-text"><h2>' . $main_title . '</h2></div>';
        }
        ...
        if (isset($btn_text) && $btn_text != '') {
            $btn_text_html = '<div class="ad-button-r1"><button class="btn btn-primary btn-theme"><a href="' . get_the_permalink($sb_post_ad_page) . '" class="color-white">' . $btn_text . '</a></button></div>';
        }
