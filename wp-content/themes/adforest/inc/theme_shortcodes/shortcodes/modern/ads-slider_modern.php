...
/* Ads */
/* ------------------------------------------------ */
if (!function_exists('ads_short_slider')) {

    function ads_short_slider() {
        $grid_array;
        ...
        vc_map(array(
            ...
            "params" => array(
                array(
                    ...
                    'description' => adforest_VCImage('ads_slider_modern.png') . __('Ouput of the shortcode will be look like this.', 'adforest'),
                ),
                array(
...
add_action('vc_before_init', 'ads_short_slider');
if (!function_exists('ads_short_slider_base_func')) {

    function ads_short_slider_base_func($atts, $content = '') {
        $no_title = 'yes';
        $modern_slider = 1;
        extract($atts);
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-12 col-xs-12 col-sm-12">
                     <div class="row">
                        <div class="featured-slider owl-carousel owl-theme">'. $html.'</div>
                     </div>
                  </div>
               </div>
            </div>
...
if (function_exists('adforest_add_code')) {
    adforest_add_code('ads_short_slider_base', 'ads_short_slider_base_func');
}