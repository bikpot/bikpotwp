...
if (!function_exists('clouds_short_base_func')) {
    ...
    function clouds_short_base_func($atts, $content = '') {
	  ...
	  <div class="container"><div class="content"><h1 class="tx-smooth">' . $main_title . '</h1>
				<a href="' . get_the_permalink($sb_search_page) . '" class="btn btn-theme">' . $search_btn_text . '</a>
				<a href="' . get_the_permalink($sb_post_ad_page) . '" class="btn btn-clean">' . $ad_btn_text . '</a>
			</div></div><div class="cloud"><img src="' . trailingslashit(get_template_directory_uri()) . 'images/cloud-pattern.png" alt="' . __('clouds', 'adforest') . '" class="img-responsive"></div></div>';
          ...
          <div class="container">
             ...
             <div class="search-section">
                ...
                <div class="new-categoy">
                    <div class="cat_lists">' . $cats_round_html . '</div>
                </div>
        </div>
    </div>';
    }
