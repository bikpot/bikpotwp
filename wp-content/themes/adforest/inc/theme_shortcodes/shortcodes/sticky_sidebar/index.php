...
function adforest_process_child($atts, $content = '') 
{
	extract(shortcode_atts(array(
	 ...
	 return '<div class="grid-card info-panel">'.$steps_html.'</div> ';		
}
...
function adforest_advertisement_child($atts, $content = '') 
{
   extract(shortcode_atts(array(
	...
	return '<div class="col-md-12"><div class="margin-bottom-40 margin-top-10">'.urldecode( adforest_decode(  $ad_720 ) ).'</div></div>';
}
