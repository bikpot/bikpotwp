	  ...
	  document.getElementById(\'ad_map_long\').value = markerz.getLatLng().lng;
        ...
        if (isset($is_update) && $is_update != "") {
            ...
            if ($is_package_notification && isset($adforest_theme['sb_show_bump_up_notification']) && $adforest_theme['sb_show_bump_up_notification']) {
                $bump_ad_html = '<div class="col-md-12 col-sm-12 col-xs-12"><div role="alert" class="alert alert-info alert-dismissible ' . adforest_alert_type() . '">
...
//        }
	   ...
	   var options = {
        ...
        return '<section class="adf-post-ad section-padding">
            <div class="container">
                <div class="row">
