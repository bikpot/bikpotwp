...
if (!function_exists('cats_fancy_short_base_func')) {
    ...
    function cats_fancy_short_base_func($atts, $content = '') {
                ...
                foreach ($rows as $row) {
                    if (isset($row['cat']) && isset($row['img'])) {
                        ...
                        $categories_html .= '<div class="col-md-3 col-sm-6">
                                                <div class="box"><img alt="' . $category->name . '" src="' . $bgImageURL . '">
                                                   <h4><a href="' . adforest_cat_link_page($row['cat'], $cat_link_page) . '">' . $category->name . '
                                                                           </a></h4><strong>' . $count . ' ' . __('Ads', 'adforest') . '</strong> 
                                                </div>
                                             </div>';
                    }
                }
        ...
        return '<section class="custom-padding categories ' . $bg_color . '" ' . $style . '><div class="container"><div class="row">' . $header . '' . $categories_html . '</div></div></section>';
    }
