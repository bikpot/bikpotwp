            ...
            if (count($rows) > 0) {
                foreach ($rows as $row) {
                    if (isset($row['cat']) && isset($row['icon'])) {
                        ...
                        $categories_html .= '<li class="col-lg-3 col-md-3 col-sm-6 col-xs-12"><a href="' . adforest_cat_link_page($row['cat'],$cat_link_page) . '">' . $category->name . '<span>(' . $count . ' ' . __('Ads', 'adforest') . ')</span><i class="' . $icon_class . '"></i></a></li>';
                    }
                }
            }
        }
        ...
        return '<section class="custom-padding ' . $bg_color . '" ' . $style . '>
            <div class="container">
			   ...
			   <div class="col-md-12 col-xs-12 col-sm-12 ">
			   		<ul class="category-list-style">' . $categories_html . '</ul>
				</div>
			   </div>
            </div>
         </section>
