...
' . $adforest_theme['sb_ad_update_notice'] . '
        ...
        $imageStaticHTML = $priceStaticHTML = $priceTypeHTML = $someStaticHTML = $customDynamicFields = $customDynamicAdType = '';
        if ($isCustom == 'no') {
		  ...
		  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			 <label class="control-label">' . __('Price', 'adforest') . '<small>' . $adforest_theme['sb_currency'] . " " . __('only', 'adforest') . '</small></label>
		...
		<div class="row">
		  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
            ...
            $someStaticHTML .= $video_html;
            $someStaticHTML .= $tags_html;
            $someStaticHTML .= '<!-- Ad Type  -->
		   <div class="row" >
			  <!-- Category  -->
			  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
