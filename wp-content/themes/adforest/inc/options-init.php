...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'default' => false,
            'required' => array('sb_header', '!=', array('vendor-1')),
        ),
        array(
            'id' => 'sb_menu_color',
            'type' => 'button_set',
        ...
        array(
            ...
            'default' => true,
            'required' => array(
                array('sb_header', '=', array('vendor-1')),
            ),
        ),
        array(
        ...
        array(
         ...
         array(
            ...
            'type' => 'select',
            'data' => 'pages',
            'title' => __('Select Page', 'adforest'),
            'subtitle' => __('for top bar vendor', 'adforest'),
            'required' => array(
                array('sb_header', '=', array('vendor-1')),
                array('sb_top_bar', '=', '1'),
            ),
        ...
        array(
            'id' => 'ad_menu_contact_num',
            'type' => 'text',
            'title' => __('Contact Number', 'adforest'),
            'default' => '0000-1122',
            'required' =>  array('sb_header', '=', array('vendor-1')),
        ),
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(        
            'id' => 'sb_all_user_style',
            'type' => 'button_set',
            'title' => __('User Grid', 'adforest'),
            'options' => array(
                '1' => __('Style 1', 'adforest'),
                '2' => __('Style 2', 'adforest'),
            ),
            'default' => '1'
        ),
        array(
    ...
    Redux::setSection($opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'default' => array('url' => trailingslashit(get_template_directory_uri()) . 'images/b-one.png'),
            ),
            array(
            ...
            array(
                ...
                'options' => array(
                    ...
                    '2' => array(
                        ...
                        'img' => esc_url(trailingslashit(get_template_directory_uri()) . 'images/no-image.png'),
                    ),
                ),
                'default' => '1'
            ),
...
<td class="content-block powered-by" style="font-family: sans-serif; font-size: 12px; vertical-align: top; color: #999999; text-align: center;"><a style="color: #999999; text-decoration: underline; font-size: 12px; text-align: center;" href="https://themeforest.net/user/scriptsbundle">Scripts Bundle</a>.</td></tr></tbody></table></div>&nbsp;</div></td><td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"></td></tr></tbody></table>&nbsp;',
            ...
            array(
                ...
                'desc' => __('%site_name% , %store_title%, %store_owner% will be translated accordingly.', 'adforest'),
...
<p>&nbsp;</p>',
            ...
            array(
                ...
                'desc' => __('%site_name% , %vendor_name%, %vendor_email% will be translated accordingly.', 'adforest'),
                'default' => '<table class="body" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f6f6f6; width: 100%;" border="0" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"></td>
...
Redux::setSection($opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'desc' => __('Site Logo image for the site.', 'adforest'),
            'subtitle' => __('Dimensions: 230 x 40', 'adforest'),
            'required' => array('footer_style', '=', array('1', '2', '3', '6', '7', '9' ,'10')),
            'default' => array('url' => trailingslashit(get_template_directory_uri()) . 'images/logo.png'),
        ),
        array(
        ...
        array(
            ...
            'required' => array('footer_style', '=', array('1', '2', '3', '9','10')),
            'default' => 'Hot Links',
        ),
          ...
          array(
            ...
            'subtitle' => __('Footer Section', 'adforest'),
            'required' => array('footer_style', '=', array('10')),
            'default' => 'Quick Links',
        ),
...
if ( ! function_exists( 'adforest_theme_license_check' ) ) {
    function adforest_theme_license_check( $field, $value ) 
    {
       ...
       if($purchase_code != ""){          
       echo '<br><br><br>';    
       echo '<input type="button"  id="sb_deactivate_license" class="button button-primary" value="'. esc_html__('Deactivate License','adforest').'">';
       } 
