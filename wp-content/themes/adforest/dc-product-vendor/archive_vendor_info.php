                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="user-detail-main">
                            ...
                            <div class="user-detail-text">
                                <h3><a herf="#"><?php echo $store_name; ?></a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="wcmpv-deatil-social clearfix margin-top-30">
							<?php echo $vendor_fb_profile . $vendor_twitter_profile . $vendor_linkdin_profile . $vendor_google_plus_profile . $vendor_youtube . $vendor_instagram; ?>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <li>
                                                <div class="arrival-main">
                                                    <div class="arrival-images">
                                                        <img src="<?php echo $prod_image_src[0]; ?>"
                                                             alt="<?php echo get_the_title( $product_id ); ?>"
                                                             class="img-responsive">
														<?php echo $new_badge_html; ?>
                                                    </div>
                                                    <div class="arrival-detail">
                                                        <p><?php echo adforest_get_woo_categories( $product_id ); ?></p>
                                                        <h3>
                                                            <a href="<?php echo esc_url( $prod_link ); ?>"><?php echo $prod_title; ?></a>
                                                        </h3>
                                                        <div class="shop-old-price"><?php echo $regular_price; ?></div>
                                                    ...
                                                    <div class="arrival-cart">
                                                        <ul class="ul-cart">
                                                            ...
                                                            <li class="favorite"><a href="javascript:void(0);"
                                                                                    ...
                                                                                    class="product_to_fav fav-link btn btn-theme <?php echo $fav_class; ?>">
    ...
    <div class="vendor_description_background wcmp_vendor_banner_template <?php echo $template_class; ?>">
        <div class="wcmp_vendor_banner">
			...
			if ( $banner != '' ) {
				...
				?>
                <img src="<?php echo $WCMp->plugin_url . 'assets/images/banner_placeholder.jpg'; ?>"
                ...
                <div class="vendor_description">
                    <div class="vendor_img_add">
                        <div class="img_div"><img
                                    src=<?php echo $profile; ?> alt="<?php echo esc_attr( $vendor->page_title ) ?>"/>
                        </div>
                        <div class="vendor_address">
							...
							<?php if ( ! empty( $location ) && $vendor_hide_address != 'Enable' ) { ?><p
                                    class="wcmp_vendor_detail"><i
                                        class="wcmp-font ico-location-icon"></i><label><?php echo $location; ?></label>
                                </p><?php } ?>
